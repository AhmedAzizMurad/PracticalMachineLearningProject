---
title: "Prediction of the manner of doing Exercise by the participants"
...
Doing the exact same 3 transformations for myTesting and testing data sets.
...
To ensure proper functioning of Decision Trees and especially RandomForest Algorithm with the Test data set (data set provided), coerce the data into the same type is needed.
...
For Random Forests the following formula is used, which yielded a much better prediction in in-sample:
